...
class FruitsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create fruit" do
    assert_difference('Fruit.count') do
      post fruits_url, params: { fruit: { comment: @fruit.comment, name: @fruit.name, priceA: @fruit.priceA, priceB: @fruit.priceB, priceC: @fruit.priceC } }
    end
  ...
  test "should update fruit" do
    patch fruit_url(@fruit), params: { fruit: { comment: @fruit.comment, name: @fruit.name, priceA: @fruit.priceA, priceB: @fruit.priceB, priceC: @fruit.priceC } }
