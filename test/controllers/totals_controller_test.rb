...
class TotalsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create total" do
    assert_difference('Total.count') do
      post totals_url, params: { total: { balance: @total.balance, inflow: @total.inflow, outflow: @total.outflow } }
    end
  ...
  test "should update total" do
    patch total_url(@total), params: { total: { balance: @total.balance, inflow: @total.inflow, outflow: @total.outflow } }
