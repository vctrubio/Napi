...
class LandlordsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create landlord" do
    assert_difference('Landlord.count') do
      post landlords_url, params: { landlord: { address: @landlord.address, description: @landlord.description, fields: @landlord.fields, name: @landlord.name, phone: @landlord.phone } }
    end
  ...
  test "should update landlord" do
    patch landlord_url(@landlord), params: { landlord: { address: @landlord.address, description: @landlord.description, fields: @landlord.fields, name: @landlord.name, phone: @landlord.phone } }
